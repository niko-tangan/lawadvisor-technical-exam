...
config :todolist_api, TodolistApiWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TodolistApiWeb.ErrorHTML, json: TodolistApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TodolistApi.PubSub,
  live_view: [signing_salt: "Vuky4yaC"]
...
# Config for Phoenix Swagger
config :todolist_api, :phoenix_swagger,
  swagger_files: %{
